            ...
            <Container maxWidth="lg">
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px' }}>
                    ...
                    <div style={{ flex: '1 1 30%' }}>
                        ...
                        <Link onClick={() => {
                            const formPage = document.getElementById('expertise'); // Assuming the FormPage component has this ID
                            if (formPage) {
                        ...
                        <Link onClick={() => {
                            const formPage = document.getElementById('services'); // Assuming the FormPage component has this ID
                            if (formPage) {
                                formPage.scrollIntoView({ behavior: 'smooth' });
                            }
                        }}  color="##fff" display="block" sx={{ mb: 1 }}>
                        ...
                        <Link onClick={() => {
                            const formPage = document.getElementById('projectsEvents'); // Assuming the FormPage component has this ID
                            if (formPage) {
                                formPage.scrollIntoView({ behavior: 'smooth' });
                            }
                        }} color="##fff" display="block" sx={{ mb: 1 }}>
